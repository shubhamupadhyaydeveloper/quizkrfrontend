                ...
                <View style={{ flex: 1 }}>
                    ...
                    >
                        <Text style={{
                            ...
                            fontSize: 18, fontFamily: "Bungee-Regular", lineHeight: 20
                        }}>
                            Shubham Upadhyay
                        </Text>
                        <Image
                    ...
                    <TouchableOpacity
                        ...
                        activeOpacity={0.7}
                    >
                        <View style={{ padding: 25, marginTop: 10, flexDirection: 'row', alignItems: 'center', backgroundColor: "#1A241F", borderRadius: 10 }}>
                            <Text style={{ color: 'white' }}>Profile</Text>
                        </View>
                    </TouchableOpacity>
                    <View style={{ padding: 25, marginTop: 10, flexDirection: 'row', alignItems: 'center', backgroundColor: "#1A241F", borderRadius: 10 }}>
                        <Text style={{ color: 'white' }}>Saved History</Text>
                    </View>
                    <View style={{ padding: 25, marginTop: 10, flexDirection: 'row', alignItems: 'center', backgroundColor: "#1A241F", borderRadius: 10 }}>
                        <Text style={{ color: 'white' }}>Meet developers</Text>
                    </View>

                    <View style={{ flex: 1, justifyContent: 'flex-end', paddingBottom: 20 }}>
                        <View style={{ padding: 25, marginTop: 10, flexDirection: 'row', alignItems: 'center', backgroundColor: "#DE3163", borderRadius: 10 }}>
